...
void ble_init(void)
{
	// String blue_name = ("CG_POINT_" + Read_EEPROM_String(EEPROM_CHARGER_ID_ADD));
	// Create the BLE Device
	BLEDevice::init(("CG_POINT_" + Read_EEPROM_String(EEPROM_CHARGER_ID_ADD)).c_str());
	// BLEDevice::init(("CG_POINT_" + Get_Chip_ID()).c_str());
