...
String Get_Charger_Name(void)
{
    String CH_NAME;
    uint8_t ch_type = Read_EEPROM_Byte(EEPROM_CHARGER_TYPE_ADD);
    switch (ch_type)
    {
    case 1:
        CH_NAME = String("CGPTF" + Read_EEPROM_String(EEPROM_CHARGER_ID_ADD));
        break;
    case 2:
        CH_NAME = String("CGPTI" + Read_EEPROM_String(EEPROM_CHARGER_ID_ADD));
        break;
    case 3:
        CH_NAME = String("CGPTT" + Read_EEPROM_String(EEPROM_CHARGER_ID_ADD));
        break;
    default:
        CH_NAME = String("CGPTF" + Read_EEPROM_String(EEPROM_CHARGER_ID_ADD));
        break;
